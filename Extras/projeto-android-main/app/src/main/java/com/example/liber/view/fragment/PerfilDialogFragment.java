...
public class PerfilDialogFragment extends DialogFragment implements PublicacaoClickInterface {
    ...
    private TextView tvIcon, tvNome, tvEmail, tvDataCadastro, tvQtdSeguidores, tvVazio;
    ...
    public PerfilDialogFragment(Usuario usuario, PesquisarClickInterface pesquisarClickInterface) {
    ...
    // Detecta o click do botão de fechar
